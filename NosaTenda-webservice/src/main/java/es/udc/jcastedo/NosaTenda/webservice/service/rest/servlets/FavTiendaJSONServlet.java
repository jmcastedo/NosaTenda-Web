...
public class FavTiendaJSONServlet extends JSONHttpServlet {
	
	private static final Logger logger = LoggerFactory.getLogger(FavTiendaJSONServlet.class);
	...
	public void doPost(HttpServletRequest request,
		...
		logger.debug("doPost de FavTiendaJSONServlet");
		...
		try {
			...
			tiendaService.favTienda(favoritoWTO.getClienteId(), favoritoWTO.getTiendaId());
