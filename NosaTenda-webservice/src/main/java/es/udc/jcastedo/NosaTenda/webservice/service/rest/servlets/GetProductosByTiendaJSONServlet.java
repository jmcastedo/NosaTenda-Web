...
public class GetProductosByTiendaJSONServlet extends JSONHttpServlet {

	private static final Logger logger = LoggerFactory.getLogger(GetProductosByTiendaJSONServlet.class);
	...
	public void doGet(HttpServletRequest request,
		...
		logger.debug("doGet de GetProductosByTiendaJSONServlet");
		...
		try {
			...
			productos = ProductoWebserviceConversor.toProductoWTO(
					productoService.getProductosByTiendaEnVenta(tiendaId));
